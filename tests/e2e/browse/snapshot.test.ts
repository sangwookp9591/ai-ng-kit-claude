...
describe('Snapshot Types and Options', () => {
  it('should accept all SnapshotOptions fields', async () => {
    ...
    const options: import('../../../browse/src/types.js').SnapshotOptions = {
      interactive: true,
      compact: false,
      depth: 3,
      selector: '#main',
  ...
  it('should allow partial SnapshotOptions (all fields optional)', async () => {
    const empty: import('../../../browse/src/types.js').SnapshotOptions = {};
    assert.equal(empty.interactive, undefined);
    assert.equal(empty.depth, undefined);
    assert.equal(empty.selector, undefined);

    const interactiveOnly: import('../../../browse/src/types.js').SnapshotOptions = {
      interactive: true,
    };
...
describe('Snapshot CommandCategory Types', () => {
  it('should only allow valid category values', () => {
    const validCategories: import('../../../browse/src/types.js').CommandCategory[] = [
      'read', 'write', 'meta',
    ];
...
describe('Snapshot BrowseState Type', () => {
  it('should accept valid BrowseState', () => {
    const state: import('../../../browse/src/types.js').BrowseState = {
      pid: 12345,
      port: 9222,
      token: 'abc123',
...
describe('Snapshot CommandResult Type', () => {
  it('should accept successful result', () => {
    const result: import('../../../browse/src/types.js').CommandResult = {
      success: true,
      output: 'Page loaded',
    };
