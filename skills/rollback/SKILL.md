...
# /aing rollback — Git Checkpoint Rollback
...
```bash
git stash push -m "aing-checkpoint-{stage}-{timestamp}" --include-untracked
git stash pop
git add -A
...
- Suggest `/aing debug` for root cause analysis
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Options:
  1. /aing rollback — 마지막 체크포인트로 롤백
  2. /aing debug — 과학적 디버깅으로 전환
  3. 수동 수정
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
