...
# /aing figma-read — Figma Spec Extraction

Figma 파일을 읽어 구조화된 기획 문서를 생성합니다.

## Usage
```
/aing figma-read <figma-url>
/aing figma-read "https://figma.com/design/abc123/MyProject?node-id=1-2"
```
...
```
Agent({
  subagent_type: "aing:figma-reader",
...
터미널 표시:
```
⏺ aing:figma-reader(Figma Reader: 기획 문서 추출) Opus
```
...
추출한 데이터를 5개 섹션으로 구조화하여 `.aing/designs/figma-spec.md`에 저장.
...
```
/aing progress-check --spec .aing/designs/figma-spec.md
```
...
- `.aing/designs/metadata.json` — Figma file/node IDs
