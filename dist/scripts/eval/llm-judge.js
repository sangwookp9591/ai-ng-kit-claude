...
// Prompt builder
// ---------------------------------------------------------------------------
export function buildEvalJudgePrompt(skillContent) {
...
// ---------------------------------------------------------------------------
function loadBaseline(skill, projectDir) {
...
export function detectRegressions(skill, currentScores, projectDir) {
...
// ---------------------------------------------------------------------------
function invokeLlm(prompt, projectDir) {
    try {
        const result = execFileSync('claude', ['-p', prompt, '--max-turns', '1'], {
            cwd: projectDir,
            timeout: 60_000,
            encoding: 'utf-8',
 ...
 */
export function runLlmJudge(skill, projectDir) {
 ...
 */
export function computeHeuristicScore(content) {
