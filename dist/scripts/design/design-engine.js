 ...
 */
export function generateTokens(brief) {
 ...
 */
export function generateComponents(brief) {
    const base = [
 ...
 */
export function scoreDesign(tokens) {
    const issues = [];
 ...
 */
export function generateDesignSystem(brief) {
 ...
 */
export function exportAsCSS(tokens, darkMode = true) {
    const lines = [];
 ...
 */
export function exportAsTailwind(tokens) {
    const colors = {};
