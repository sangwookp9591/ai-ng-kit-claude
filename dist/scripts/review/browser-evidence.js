...
import { parseAriaSnapshot, formatRefs } from './aria-refs.js';
...
export function formatBrowserEvidence(entries) {
    const browserEntries = entries.filter(e => Object.values(BROWSER_EVIDENCE_TYPES).includes(e.type));
    if (browserEntries.length === 0)
        return 'No browser evidence collected.';
 ...
 */
export function orchestrateBrowserQA(feature, config, _projectDir) {
...
//# sourceMappingURL=browser-evidence.js.map