...
function detectTier(tmplContent) {
    if (tmplContent.includes('{{PREAMBLE_T4}}'))
        return 'T4';
    if (tmplContent.includes('{{PREAMBLE_T3}}'))
        return 'T3';
    if (tmplContent.includes('{{PREAMBLE_T2}}'))
        return 'T2';
    if (tmplContent.includes('{{PREAMBLE_T1}}'))
        return 'T1';
    return 'none';
}
// -- Template Resolution --
...
main();
//# sourceMappingURL=gen-skill-docs.js.map