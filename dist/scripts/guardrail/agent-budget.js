...
function getOrInit(projectDir) {
    const state = readStateOrDefault(budgetPath(projectDir), null);
 ...
 */
export function trackAgentSpawn(projectDir, agentName) {
 ...
 */
export function recordAgentCompletion(projectDir, agentName, durationMs) {
    const state = getOrInit(projectDir);
 ...
 */
export function resetAgentBudget(projectDir) {
 ...
 */
export function getAgentBudgetStatus(projectDir) {
