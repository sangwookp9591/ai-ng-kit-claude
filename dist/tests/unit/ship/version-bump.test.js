...
import { parseVersion, determineBumpType, bumpVersion, readVersion, } from '../../../scripts/ship/version-bump.js';
...
describe('bumpVersion', () => {
    it('bumps patch from VERSION file', () => {
        ...
        expect(mockWriteFileSync).toHaveBeenCalledWith(expect.stringContaining('VERSION'), '1.2.4\n');
    });
...
//# sourceMappingURL=version-bump.test.js.map