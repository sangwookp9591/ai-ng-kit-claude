...
import { parseCommitMessage, generateChangelog, prependChangelog, getCommitsSince, } from '../../../scripts/ship/changelog-gen.js';
...
describe('getCommitsSince', () => {
    it('parses git log output into CommitEntry array', () => {
        mockExecSync.mockImplementation((cmd) => {
            if (String(cmd).includes('describe --tags'))
    ...
    it('uses provided since ref', () => {
        mockExecSync.mockImplementation((cmd) => {
            if (String(cmd).includes('v1.0.0..HEAD'))
                return 'abc|msg|author|date';
            return '';
        });
...
//# sourceMappingURL=changelog-gen.test.js.map