...
// ── Internal helpers ──────────────────────────────────────────────────────
function buildPrompt(skillName, output, expectedBehavior, criteria) {
 ...
 */
export async function judgeOutput(skillName, output, expectedBehavior, criteria = DEFAULT_CRITERIA) {
