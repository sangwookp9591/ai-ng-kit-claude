 ...
 */
export const DEFAULT_EVAL_REGISTRY: EvalRegistryEntry[] = [
 ...
 */
export function getChangedFiles(baseBranch: string = 'main', cwd?: string): string[] {
 ...
 */
export function getUncommittedChanges(cwd?: string): string[] {
  const dir = cwd ?? process.cwd();
 ...
 */
export function getAffectedEvals(
  changedFiles: string[],
  evalRegistry: EvalRegistryEntry[] = DEFAULT_EVAL_REGISTRY,
): string[] {
