 ...
 */
import { AI_SLOP_BLACKLIST, LITMUS_CHECKS, detectAISlop, type DetectedSlop, type LitmusCheck } from './design-scoring.js';
 ...
 */
export function runDesignReview(diff: string): DesignReviewResult {
 ...
 */
export function recordDesignReview(result: DesignRecordResult, projectDir?: string): void {
