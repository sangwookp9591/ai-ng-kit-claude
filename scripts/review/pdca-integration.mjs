 ...
 */
import { buildDashboard } from './review-dashboard.mjs';
import { selectTiers } from './review-engine.mjs';
 ...
 * @param {string} context.pdcaStage - Current PDCA stage
 * @param {string} context.pdcaVerdict - PDCA verdict (ACHIEVED/COMPLETED_BUT_INCOMPLETE/FAILED)
 * @param {string} context.evidenceVerdict - Evidence chain verdict (PASS/FAIL/INCOMPLETE)
 * @param {string} [context.projectDir]
 * @returns {{ canShip: boolean, reason: string, blockers: string[] }}
 */
 ...
 * @param {string} context.pdcaStage
 * @returns {{ tiers: string[], reason: string }}
 */
 ...
 *
 * @param {object} readiness - Output of checkShipReadiness()
 * @param {object} dashboard - Review dashboard data
 * @returns {string}
 */
export function formatShipReadiness(readiness, dashboard) {
  const lines = [
    '┌─────────────────────────────────┐',
