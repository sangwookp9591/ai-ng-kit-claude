 ...
 */
import { readReviewLog, getLatestReview, checkStaleness } from './review-log.mjs';
import { execSync } from 'node:child_process';
import { createLogger } from '../core/logger.mjs';

const log = createLogger('review-dashboard');
 ...
 * @param {object} dashboard - Output of buildDashboard()
 * @returns {string}
 */
