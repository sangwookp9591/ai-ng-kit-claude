 ...
 */
export function parseAriaSnapshot(snapshotText: string): Map<string, AriaRefEntry> {
 ...
 */
export function formatRefs(refs: Map<string, AriaRefEntry>): string {
 ...
 */
export function findRefs(refs: Map<string, AriaRefEntry>, query: string): Array<[string, AriaRefEntry]> {
 ...
 */
export function checkStale(oldRefs: Map<string, AriaRefEntry>, newRefs: Map<string, AriaRefEntry>): StaleCheckResult {
 ...
 */
export function buildAction(ref: string, action: string, refs: Map<string, AriaRefEntry>, value?: string): ActionResult | null {
