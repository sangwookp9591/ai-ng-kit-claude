 ...
 */
export const CEO_CHECKS: CEOCheck[] = [
 ...
 */
export function buildCEOReviewPrompt(context: CEOReviewContext): string {
 ...
 */
export function recordCEOReview(result: CEOReviewResult, projectDir?: string): void {
