 ...
 */
export const CAREFUL_PATTERNS: CarefulPattern[] = [
 ...
 */
export function checkFreeze(filePath: string, config?: FreezeConfig): CarefulResult {
 ...
 */
export function formatCarefulResult(result: CarefulResult): string {
