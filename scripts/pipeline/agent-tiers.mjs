 ...
 *
 * @param {string} agentName - Key in AGENT_TIERS
 * @param {number} complexityScore - 0-10 complexity score from complexity-scorer
 * @returns {{ agent: string, tier: number, model: string, description: string } | null}
 */
 ...
 *
 * @param {string} preset - Pipeline preset name: 'solo' | 'duo' | 'squad' | 'full'
 * @param {number} complexityScore - 0-10 complexity score
 * @returns {Array<{ name: string, agent: string, tier: number, model: string, description: string }>}
 */
 ...
 * @param {Array<{ name: string, agent: string, tier: number, model: string, description: string }>} agents
 * @returns {string}
 */
