 ...
 * @param {object} entry
 * @param {string} entry.feature - Feature being worked on
 * @param {string} entry.discovery - What was discovered
 * @param {string} entry.rationale - Why it matters
 * @param {string[]} [entry.files] - Related file paths
 * @param {boolean} [entry.reusable] - Whether this is a reusable pattern
