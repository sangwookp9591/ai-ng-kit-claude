 ...
 */
import { REVIEW_AGENTS } from '../../review/review-engine.mjs';

/**
 * Generate the review tiers table.
 * @returns {string} Markdown table
 */
export function resolveReviewTiers() {
  const lines = [
    '| Tier | Agents | Focus | Required |',
    '|------|--------|-------|----------|',
  ];

  for (const [key, config] of Object.entries(REVIEW_AGENTS)) {
 ...
 * @returns {string} Markdown instructions for agents
 */
export function resolveReviewDashboard() {
 ...
 * @returns {string}
 */
export function resolveScopeDriftCheck() {
