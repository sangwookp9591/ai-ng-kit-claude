 ...
 * @returns {{ platform: object|null, config: object|null }}
 */
 ...
 * @param {object} result - Output of detectPlatform()
 * @returns {string}
 */
 ...
 * @param {string} url
 * @returns {{ healthy: boolean, statusCode: number|null, error?: string }}
 */
