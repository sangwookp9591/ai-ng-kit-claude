...
const log = createLogger('doc-release');
 ...
 * @param {string[]} changedFiles - Files changed in the diff
 * @param {string} [projectDir]
 * @returns {Array<{ file: string, focus: string, exists: boolean, reason: string }>}
 */
 ...
 * @param {Array} staleDocs - Output of findStaleDocs()
